      ...
      <div className="main-content-group">
        {weatherAlert && (
          <div style={{ width: '100%', display: 'flex', justifyContent: 'center', flexShrink: 0, paddingLeft: 24, paddingRight: 24, boxSizing: 'border-box' }}>
            <div style={{ width: '100%', maxWidth: 344, padding: '8px 28px', boxSizing: 'border-box', backgroundColor: '#FFFFFF', border: '1.5px solid #000000', borderRadius: 12, boxShadow: '2px 2px 0px 0px #000000', textAlign: 'center' }}>
